...
const faqs = [
  { question: "Do I need to switch my CRM?", answer: "Nope. We integrate with whatever you're already using — or we can set you up from scratch. Either way, we handle all the technical wiring during onboarding so you don't have to worry about a thing." },
  ...
  { question: "What is the AI Consulting service?", answer: "We run full-day, hands-on AI transformation sessions with your team. At $3,500 per employee, we teach your people how to use AI tools to dramatically speed up their daily workflows — proposals, reports, customer communication, and more. Most teams see measurable productivity gains within the first week." },
  { question: "Do you serve businesses outside Winnipeg?", answer: "Right now we're focused exclusively on Winnipeg. We believe in serving our local community deeply rather than spreading thin. If you're a Winnipeg business, we'd love to talk." },
