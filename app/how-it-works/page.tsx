    ...
    <>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
            {[
              ...
              { name: "CRM Pipelines", desc: "We integrate with your existing CRM pipelines, workflows, and contact records — whatever system you use.", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7"><path d="M3 3v18h18" /><path d="m7 16 4-8 4 5 4-9" /></svg> },
      ...
      <section className="bg-slate-50 py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
            {[
              { title: "No CRM Switch Required", desc: "Keep the tools you love. Your Lead Nest layers on top of your existing CRM — HubSpot, Salesforce, or even a spreadsheet." },
